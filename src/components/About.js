    ...
    <section className="page">
      ...
      <ul className="faq">
        ...
        <li>
          ...
          <p>
            This website was inspired by the original work of {" "}
            <Link
            ...
            >
             ...
             as a foundation to learn React and bootstrapping with 
            the Create React App. This project is currently in progress while I learn 
            to build a multi-step form in React. If you have a great idea for a new 
            feature or something to make it better I would love to hear from you. Feel free to 
            email me directly at {" "}
            <Link
              to="mailto:shyla.nott@gmail.com"
              target="_blank"
              rel="noopener noreferrer"
            >
              {" "}
              shyla.nott@gmail.com
            </Link>
            .
          </p>
        </li>
